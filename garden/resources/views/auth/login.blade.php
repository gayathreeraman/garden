            ...
            <div>
                ...
                <br>
                    <div class="loginemail">Email</div>
                        ...
                        <div><input class="inputpw"type="password" name="password" id="password" size="35">@if(count($errors) > 0)
                    ...
                    @endif</div>
                        ...
                        {{-- <div class="remember"><input type="checkbox" name="remember"> Remember Me
                        @if(count($errors) > 0)
